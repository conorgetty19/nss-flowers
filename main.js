...
const inexpensiveFlowers = () => {
    ...
    //use if statement to determine which flowers are inexpensive
    //populate array with inexpensive flowers using .push()
...
const zoneFlowers = () => {
    ...
    //use if statement to determine which flowers grow in zone 3 AND 8
    //populate filteredFlowers array with flowers that do using .push()
    for (flower of flowers){
        if (flower.usdaZones.includes(3)){
            if (flower.usdaZones.includes(8)){
                filteredFlowers.push(flower) 
            }
...
const orangeFlowers = () => {
    ...
    //iterate flowers array
    //use if statement to determine which flowers come in Orange
    //populat filteredFlowers with flowers that do
    for (flower of flowers){
...
const flowersAsHTML = () => {
    ...
    //for each flower in array add the following to the empty string:
    //opening article element
    //the ${flower.type}, contained in an h1 element
    //Colors in an h2 element
    //iterate through the flowers colors, and add to string (<sectiom>${color}</section>)
    //USDA Zones in an h2
    //iterate through the flowers zones and add to string (<div>${zone1}</div>)
    //closing article element
